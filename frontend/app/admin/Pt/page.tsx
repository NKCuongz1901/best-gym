...
import { getAccountUser, getPtAccounts } from '@/app/services/api';
import { FILTER_PROPS } from '@/app/types/filters';
import { PtAccountsResponse, UserAccountsResponse } from '@/app/types/types';
...
const columns: TableProps<DataType>['columns'] = [
  ...
  },
  {
    title: 'Name',
    key: 'name',
    render: (_value, record: DataType) => record.profile?.name ?? '',
  },
  {
    title: 'Action',
    dataIndex: 'action',
